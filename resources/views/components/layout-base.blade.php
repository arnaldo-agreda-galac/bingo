        ...
        <div class="fixed flex flex-col left-0 w-14 hover:w-64 md:w-64 bg-gradient-to-b from-teal-800 to-sky-600 h-full text-white transition-all duration-300 border-none z-10 sidebar">
            ...
            <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
                <ul class="flex flex-col py-4 space-y-1">
                    ...
                    <li>
                        <x-menu-item icono="fa-home" ruta="{{route('home')}}">Dashboard</x-menu-item>
                    </li>
                    <li>
                        <x-menu-item icono="fa-gamepad" ruta="{{route('partidas.index')}}">Partidas</x-menu-item>
                    </li>
                    <li>
                        <x-menu-item icono="fa-braille" ruta="{{route('cartones.index')}}">Cartones</x-menu-item>
                    </li>
                    <li class="px-5 hidden md:block">
